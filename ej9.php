...
if ($totalUsers > 0) {
    ...
    echo "Users with no favorite dishes:\n";
    foreach ($noFavoritesUsers as $user) {
        echo "$user\n";
    }

    echo "\nAverage Age of Users with no favorite dishes: $averageAge years\n";
    echo "<pre>";
} else {
    echo "No users found with no favorite dishes.\n";
    echo "<pre>";
}
?>